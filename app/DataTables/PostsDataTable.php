...
class PostsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('gersos', function ($post) {
                return $this->getGersos($post);
            })
            ...
            ->rawColumns(['categories', 'gersos', 'comments_count', 'action', 'created_at']);
    }
    ...
    {
        $query = isRole('redac') ? dd(auth()->user())->posts() : $post->newQuery();
    ...
    protected function getColumns()
    {
        ...
        array_push($columns,
            ...
            Column::computed('gersos')->title(__('Sous categories')),
    ...
    protected function getGersos($post)
    {
        $html = '';

        foreach($post->gersos as $gerso) {
            $html .= $gerso->title . '<br>';
        }
