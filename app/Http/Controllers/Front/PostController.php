...
use App\Models\{ Category, User, Tag, Post};
...
class PostController extends Controller
{
    ...
    */
    ...
    public function show(Request $request, $slug)
    {
        ...
        $nbrcmnt = $post->comments()->count();
        
        return view('front.post', compact('post', 'nbrcmnt'));
    }
    ...
    {
        $categorys = $this->postRepository->getPostByCategoriSlug($slug);
        
        return view('front.categories', compact('categorys'));
    ...
    public function user(User $user)
    {
        ...
        return view('front.users', compact('posts', 'title'));
    }
    ...
    public function tag(Tag $tag)
    {
        ...
        return view('front.tags', compact('posts', 'title'));
    }
    ...
    {
        $post = $this->postRepository->getPostBySlug($slug);
        $pdf = PDF::loadView('front.cours.pdf', compact('post'));
        
        return $pdf->download('softcode.pdf');        
    }
