...
use App\Models\{ Post, Category, Gerso, Fichier };
...
class PostController extends Controller
{
    ...
    public function create($id = null)
    {
        ...
        $gersos = Gerso::all()->pluck('title', 'id');
        $filles = Fichier::all()->pluck('title', 'id');

        return view('back.posts.form', compact('post', 'categories', 'gersos', 'filles'));
    }
